...
// 使用message关键字定义需要用到的消息类型
// 用于发起请求的消息中包含一个名为name的string字段
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x79, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2e, 0x2f, 0x3b, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f,
